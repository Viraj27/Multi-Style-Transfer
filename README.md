...
1. Add image sample for style transfer and the image after a set of iterations to show the transitions.
2. Add explanations in the notebooks in the form of comments.